...
pub struct RecurringBillLine {
    pub id: String,
    pub recurring_bill_id: String,
...
pub struct RecurringBill {
    ...
    pub is_active: bool,
    pub days_due: i32,
    pub lines: Vec<RecurringBillLine>,
    pub created_at: OffsetDateTime,
    pub updated_at: OffsetDateTime,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CreateRecurringBillLine {
    pub description: String,
    pub quantity: i32,
    pub unit_price: MinorUnits,
    pub account_id: Option<String>,
...
pub struct CreateRecurringBill {
    ...
    pub days_due: i32,
    pub lines: Vec<CreateRecurringBillLine>,
}
